...
class Deepfashion2Agg81KpsDatasetPerCategory(JointsDataset):
    '''
    "keypoints": {
        0: "nose",
        1: "left_eye",
    ...
    def __init__(self, cfg, root, image_set, is_train, transform=None):
        ...
        # per category by lzhbrian
        self.train_category_id = cfg.train_category_id
        print('training category', self.train_category_id)
    ...
    def _get_ann_file_keypoint(self):
        ...
        if prefix == 'train':
            return os.path.join(
                self.root, 'annotations_per_category_agg81kps',
                f'{prefix}_coco_category_{self.train_category_id}.json'
            )
        elif prefix == 'validation':
            return os.path.join(
                self.root, 'annotations_per_category',
                f'{prefix}_coco_category_{self.train_category_id}.json'
            )
        elif prefix == 'test':
            return os.path.join(
            ...
            print('ERROR, not supported _get_ann_file_keypoint prefix', prefix)
